...
class Unit {
  ...
  static async updateUnitOccupancy(data, callBack) {
    try {
      ...
      const conditionList = data;
      const result = db.query(
        `UPDATE units SET unit_occupancy = 2 WHERE unit_id = ?;`,
        conditionList,
        (error, results, field) => {
          if (error) {
            return callBack(error);
  ...
  static async getAllUnitsByPropertyID(id) {
    try {
      const result = await db.query(
        "SELECT * FROM units WHERE unit_property_id = ?",
        [id]
      );
      return result;
    } catch (error) {
  ...
  static async getAllVacantUnitsByPropertyID1(id) {
    try {
      const result = await db.query(
        "SELECT * FROM units WHERE unit_occupancy=2 AND unit_property_id = ?",
        [id]
      );
      return result;
    } catch (error) {
  ...
  static async getAllVacantUnitsByPropertyID(data, callBack) {
    try {
      ...
      const conditionList = [data];
      const result = db.query(
        `SELECT * FROM units WHERE unit_occupancy=1 AND unit_property_id = ?`,
        conditionList,
        (error, results, field) => {
          if (error) {
            return callBack(error);
...
`,
  ...
  static async getUnitDataBypropIDunitID1(conditionList) {
    try {
      const columnList = "*";
      const result = await db.query(
        `SELECT * FROM units WHERE unit_property_id =? and unit_id = ? `,
        conditionList,
        (error, results, field) => {
          if (error) {
            return error;
